...
<body>
  ...
  <section class="cta">
    ...
    <div class="cta-small">7-day trial · cancel anytime · access keeps the whole library, not one concept.</div>
  </section>
  ...
  <div class="paywall" aria-hidden="true">
    <div class="paywall-card">
      ...
      <div class="pw-small">7-day free trial · cancel anytime · already a member? <a href="/account.html">Sign in →</a></div>
    </div>
  </div>
