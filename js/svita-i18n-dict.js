...
window.I18N = {
  ...
  step1_li1: { en: '90 concepts', ru: '90 концепций', pl: '90 koncepcji', uk: '90 концепцій', be: '90 канцэпцый' },
  ...
  final_p: {
    en: '90 concepts waiting. One is probably the one.',
    ru: '90 концепций ждут. Одна из них точно ваша.',
    pl: '90 koncepcji czeka. Jedna jest prawdopodobnie tą jedyną.',
    uk: '90 концепцій чекають. Одна з них точно ваша.',
    be: '90 канцэпцый чакаюць. Адна з іх дакладна ваша.'
  },
  final_cta: {
    en: 'Open the shop',
    ru: 'Открыть магазин',
  ...
  sub_hero_lead:      { en: 'A library of 91 ready-to-launch business concepts — each one a full brandbook, not a teaser. One card opens all of it.', ru: 'Библиотека из 91 готовой к запуску бизнес-концепции — каждая полный брендбук, а не тизер. Одна карта открывает всё.', pl: 'Biblioteka 91 gotowych do uruchomienia konceptów — każdy pełny brandbook, nie tylko zajawka. Jedna karta otwiera wszystko.', uk: 'Бібліотека з 91 готової до запуску бізнес-концепції — кожна повний брендбук, а не тизер. Одна карта відкриває все.', be: 'Бібліятэка з 91 гатовай да запуску бізнес-канцэпцыі — кожная поўны брэндбук, а не тызер. Адна карта адкрывае ўсё.' },
  ...
  sub_b_access:       { en: 'Access to all 91 concepts', ru: 'Доступ ко всем 91 концепции', pl: 'Dostęp do wszystkich 91 konceptów', uk: 'Доступ до всіх 91 концепцій', be: 'Доступ да ўсіх 91 канцэпцый' },
  ...
  sub_p1_h:           { en: 'The whole library — 91 concepts', ru: 'Вся библиотека — 91 концепция', pl: 'Cała biblioteka — 91 konceptów', uk: 'Уся бібліотека — 91 концепція', be: 'Уся бібліятэка — 91 канцэпцыя' },
  ...
  acc_pick_first_p: { en: '90+ ready-to-launch concepts waiting. Coffee shops, matcha kiosks, ramen bars, beauty salons. Open the whole library — $19/mo.', ru: '90+ готовых к запуску концепций. Кофейни, матча-киоски, рамен-бары, салоны красоты. Откройте всю библиотеку — $19/мес.', pl: '90+ gotowych konceptów. Kawiarnie, kioski matcha, bary ramen, salony piękności. Otwórz całą bibliotekę — $19/mies.', uk: '90+ готових до запуску концепцій. Кавʼярні, матча-кіоски, рамен-бари, салони краси. Відкрийте всю бібліотеку — $19/міс.', be: '90+ гатовых да запуску канцэпцый. Кавярні, матча-кіёскі, рамен-бары, салоны прыгажосці. Адкрыйце ўсю бібліятэку — $19/мес.' },
  ...
  sub_eyebrow: { en: 'one subscription · whole library', ru: 'одна подписка · вся библиотека', pl: 'jedna subskrypcja · cała biblioteka', uk: 'одна підписка · вся бібліотека', be: 'адна падпіска · уся бібліятэка' },
  sub_hero_h1: { en: 'One subscription. <span class="it">Every concept.</span>', ru: 'Одна подписка. <span class="it">Все концепции.</span>', pl: 'Jedna subskrypcja. <span class="it">Każdy koncept.</span>', uk: 'Одна підписка. <span class="it">Усі концепції.</span>', be: 'Адна падпіска. <span class="it">Усе канцэпцыі.</span>' },
  sub_hero_lead: { en: 'A library of 91 ready-to-launch business concepts — each one a full brandbook, not a teaser. One card opens all of it.', ru: 'Библиотека из 91 готовой к запуску бизнес-концепции — каждая полный брендбук, не тизер. Одна карта открывает всё.', pl: 'Biblioteka 91 gotowych do startu konceptów biznesowych — każdy to pełny brandbook, nie teaser. Jedna karta otwiera wszystko.', uk: 'Бібліотека з 91 готової до запуску бізнес-концепції — кожна повний брендбук, не тизер. Одна картка відкриває все.', be: 'Бібліятэка з 91 гатовай да запуску бізнес-канцэпцыі — кожная поўны брэндбук, не тызэр. Адна карта адкрывае ўсё.' },
  sub_trust_trial: { en: '7 days free', ru: '7 дней бесплатно', pl: '7 dni za darmo', uk: '7 днів безкоштовно', be: '7 дзён бясплатна' },
  ...
  sub_b_access: { en: 'Access to all 91 concepts', ru: 'Доступ ко всем 91 концепции', pl: 'Dostęp do wszystkich 91 konceptów', uk: 'Доступ до всіх 91 концепцій', be: 'Доступ да ўсіх 91 канцэпцыі' },
