...
window.I18N = {
  ...
  idx_tier_best_value: { en: 'best value', ru: 'лучший выбор', pl: 'najlepszy wybór', uk: 'найкращий вибір', be: 'найлепшы выбар' },
  idx_tier_monthly_name: { en: 'Monthly', ru: 'Помесячно', pl: 'Miesięcznie', uk: 'Помісячно', be: 'Штомесяц' },
  idx_tier_yearly_name:  { en: 'Yearly · −35%', ru: 'Год · −35%', pl: 'Rocznie · −35%', uk: 'Річно · −35%', be: 'Год · −35%' },
  idx_tier_monthly_unit: { en: '/ mo', ru: '/ мес', pl: '/ mies', uk: '/ міс', be: '/ мес' },
  idx_tier_yearly_unit:  { en: '/ year', ru: '/ год', pl: '/ rok', uk: '/ рік', be: '/ год' },
  idx_tier_monthly_sub: {
    en: 'The whole library. Every brandbook, every page. Cancel anytime — nothing is lost.',
    ru: 'Вся библиотека. Каждый брендбук, каждая страница. Отменить можно в любой момент — ничего не теряется.',
    pl: 'Cała biblioteka. Każdy brandbook, każda strona. Anulujesz, kiedy chcesz — nic nie tracisz.',
    uk: 'Уся бібліотека. Кожен брендбук, кожна сторінка. Скасувати можна будь-коли — нічого не втрачаєте.',
    be: 'Уся бібліятэка. Кожны брэндбук, кожная старонка. Адмяніць можна заўжды — нічога не губляецца.'
  },
  idx_tier_yearly_sub: {
    en: 'The same library in one annual payment. Works out roughly two months cheaper than monthly.',
    ru: 'Та же библиотека одним годовым платежом. Выходит примерно на два месяца дешевле помесячного.',
    pl: 'Ta sama biblioteka w jednej rocznej płatności. Wychodzi około dwa miesiące taniej niż miesięcznie.',
    uk: 'Та сама бібліотека одним річним платежем. Виходить приблизно на два місяці дешевше за помісячний.',
    be: 'Тая ж бібліятэка адным гадавым плацяжом. Выходзіць прыкладна на два месяцы танней за штомесячны.'
  },
  idx_tier_b_all:    { en: 'access to all {N} concepts', ru: 'доступ ко всем {N} концепциям', pl: 'dostęp do wszystkich {N} koncepcji', uk: 'доступ до всіх {N} концепцій', be: 'доступ да ўсіх {N} канцэпцый' },
  idx_tier_b_unlock: { en: 'new concepts unlock instantly', ru: 'новые концепции открываются сразу', pl: 'nowe koncepcje odblokowują się od razu', uk: 'нові концепції відкриваються одразу', be: 'новыя канцэпцыі адкрываюцца адразу' },
  idx_tier_b_2days:  { en: '2 days free', ru: '2 дня бесплатно', pl: '2 dni gratis', uk: '2 дні безкоштовно', be: '2 дні бясплатна' },
  idx_tier_b_cancel: { en: 'cancel in one click', ru: 'отмена в один клик', pl: 'anulowanie jednym kliknięciem', uk: 'скасування в один клік', be: 'адмена ў адзін клік' },
  idx_tier_b_y_all:    { en: 'everything in Monthly', ru: 'всё из помесячного', pl: 'wszystko z miesięcznego', uk: 'усе з помісячного', be: 'усё са штомесячнага' },
  idx_tier_b_y_save:   { en: 'about −35% vs monthly', ru: 'около −35% к помесячному', pl: 'około −35% w stosunku do miesięcznego', uk: 'близько −35% до помісячного', be: 'каля −35% да штомесячнага' },
  idx_tier_b_y_one:    { en: 'one invoice a year — no surprise charges', ru: 'один счёт в год — никаких неожиданных списаний', pl: 'jedna faktura rocznie — bez niespodzianek', uk: 'один рахунок на рік — жодних несподіванок', be: 'адзін рахунак у год — без нечаканасцей' },
  idx_tier_b_y_cancel: { en: 'cancel before the next renewal', ru: 'отмена до следующего продления', pl: 'anulowanie przed kolejnym odnowieniem', uk: 'скасування до наступного поновлення', be: 'адмена да наступнага падаўжэння' },
  idx_tier_cta_monthly: { en: 'Start free trial', ru: 'Начать бесплатно', pl: 'Rozpocznij darmowy okres', uk: 'Почати безкоштовно', be: 'Пачаць бясплатна' },
  idx_tier_cta_yearly:  { en: 'Pay yearly', ru: 'Оплатить за год', pl: 'Zapłać rocznie', uk: 'Оплатити за рік', be: 'Заплаціць за год' },
  /* ─── Page <title> i18n — used by js/svita-title-i18n.js on each page ─── */
  page_title_shop:      { en: 'SVITA Micro — Shop',         ru: 'SVITA Micro — Магазин',      pl: 'SVITA Micro — Sklep',         uk: 'SVITA Micro — Магазин',     be: 'SVITA Micro — Крама' },
  page_title_subscribe: { en: 'SVITA Micro — Subscription', ru: 'SVITA Micro — Подписка',     pl: 'SVITA Micro — Subskrypcja',   uk: 'SVITA Micro — Підписка',    be: 'SVITA Micro — Падпіска' },
  page_title_account:   { en: 'SVITA Micro — Account',      ru: 'SVITA Micro — Аккаунт',      pl: 'SVITA Micro — Konto',         uk: 'SVITA Micro — Акаунт',      be: 'SVITA Micro — Акаўнт' },
  page_title_generate:  { en: 'SVITA Micro — Generate your concept', ru: 'SVITA Micro — Создать концепцию', pl: 'SVITA Micro — Wygeneruj swój koncept', uk: 'SVITA Micro — Згенерувати концепцію', be: 'SVITA Micro — Згенераваць канцэпцыю' },
  page_title_view:      { en: 'Opening concept… — micro.svita', ru: 'Открываем концепцию… — micro.svita', pl: 'Otwieram koncept… — micro.svita', uk: 'Відкриваємо концепцію… — micro.svita', be: 'Адкрываем канцэпцыю… — micro.svita' },
  page_title_license:   { en: 'License · SVITA Micro',      ru: 'Лицензия · SVITA Micro',     pl: 'Licencja · SVITA Micro',      uk: 'Ліцензія · SVITA Micro',    be: 'Ліцэнзія · SVITA Micro' },
  page_title_refund:    { en: 'Refund · SVITA Micro',       ru: 'Возврат · SVITA Micro',      pl: 'Zwrot · SVITA Micro',         uk: 'Повернення · SVITA Micro',  be: 'Зварот · SVITA Micro' },
  page_title_imprint:   { en: 'Imprint · SVITA Micro',      ru: 'Реквизиты · SVITA Micro',    pl: 'Stopka prawna · SVITA Micro', uk: 'Реквізити · SVITA Micro',   be: 'Рэквізіты · SVITA Micro' },
  page_title_legal:     { en: 'Legal · SVITA MICRO',        ru: 'Правовая · SVITA MICRO',     pl: 'Prawne · SVITA MICRO',        uk: 'Юридична · SVITA MICRO',    be: 'Юрыдычная · SVITA MICRO' },
  page_title_terms:     { en: 'Terms · SVITA Micro',        ru: 'Условия · SVITA Micro',      pl: 'Regulamin · SVITA Micro',     uk: 'Умови · SVITA Micro',       be: 'Умовы · SVITA Micro' },
  page_title_privacy:   { en: 'Privacy · SVITA Micro',      ru: 'Приватность · SVITA Micro',  pl: 'Prywatność · SVITA Micro',    uk: 'Приватність · SVITA Micro', be: 'Прыватнасць · SVITA Micro' },
